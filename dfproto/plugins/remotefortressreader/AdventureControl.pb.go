...
func (AdvmodeMenu) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_AdventureControl_79cbf3fb00e77630, []int{0}
}
...
func (CarefulMovementType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_AdventureControl_79cbf3fb00e77630, []int{1}
}
...
func (MiscMoveType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_AdventureControl_79cbf3fb00e77630, []int{2}
}
...
func (*MiscMoveParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_AdventureControl_79cbf3fb00e77630, []int{3}
}
...
func init() {
	proto.RegisterFile("AdventureControl.proto", fileDescriptor_AdventureControl_79cbf3fb00e77630)
}

var fileDescriptor_AdventureControl_79cbf3fb00e77630 = []byte{
